...
随笔并不是简单的把某个框架的使用命令、代码案例整理出来，这些内容官网文档基本上都有的，我们要学会并习惯看官方文档，
现在很多官网都提供中文，实在不行也可以从网络上找到教程。
...
- MySQL。入门：《MySQL从入门到精通》；进阶：《高性能MySql》、《MySQL技术内幕：InnoDB存储引擎》；大师：《MySQL 源码剖析》
- Linux。《鸟哥的Linux私房菜》

### 架构师
1. 设计模式与架构方法论：《设计模式：可复用面向对象软件的基础》《架构整洁之道》《领域驱动设计：软件核心复杂性应对之道》《系统架构：复杂系统的产品设计与开发》
2. 分布式系统与微服务架构：《微服务架构设计模式》《分布式系统概念与设计》《Kubernetes 权威指南》《架构即未来：现代企业可扩展的Web架构、流程和组织》
3. 性能优化与中间件技术：《Java 性能权威指南》《高性能 MySQL》《Redis 设计与实现》
4. 工程实践与团队协作：《持续交付：发布可靠软件的系统方法》《重构：改善既有代码的设计》《代码整洁之道》
5. 前沿技术：《云原生架构：方法论与实践》《演进式架构》《数据密集型应用系统设计》
