...
- [Flink调优面试题及参考答案20道](https://mp.weixin.qq.com/s/-TVoyI701Q_-6uaUeZDYHA)
- [Flink背压：原理、定位与解决，一文搞定](https://mp.weixin.qq.com/s/38d8gaI9mgElGQPVzeYCqQ)
...
前大数据时代的产物，基础SQL查询，并非基于日志，通常用于离线数据场景，也就是ETL技术。
...
常见工具
1. kettle。最早是一个开源的ETL工具，提供简单的可视化工具，基础支持所有常见的数据库、文件存储等ETL操作。
2. sqoop
