...
| **A2 第二梯队** | | |
| CC 工作流第二梯队 | [🟢 cheatsheet-full-1.png](cc-workflows-extras/ccwfe-full-1.png) | [🟢 cheatsheet-tiny-1.png](cc-workflows-extras/ccwfe-tiny-1.png) |
| **A3 全景** | | |
| CC 工作流全景 | [🟦 cheatsheet-full-1.png](cc-workflows/ccwf-full-1.png) | [🟦 cheatsheet-tiny-1.png](cc-workflows/ccwf-tiny-1.png) |

### 🅱 B 河速查卡

| 平台 / 总图 | 完整版(A4) | 极简版(A5) |
|---|---|---|
| **7 大平台** | [🟧 cheatsheet-full-1.png](general-ai-workflows/gaw-full-1.png) | [🟧 cheatsheet-tiny-1.png](general-ai-workflows/gaw-tiny-1.png) |
...
|---|---|---|---|
| **8 阶段工作流** | [🟦 cheatsheet-full-1.png](spring-cloud-workflow/java-full-1.png) | [🟦 cheatsheet-tiny-1.png](spring-cloud-workflow/java-tiny-1.png) | [🟦 flow-diagram-1.png](spring-cloud-workflow/java-diagram-1.png) |
