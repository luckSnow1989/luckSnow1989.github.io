...
爬虫类。核心为MCP。横向对比：https://my.feishu.cn/wiki/UIgtwNalziel5KkXz1RcRqN8n2d
- Playwright MCP。微软的浏览器自动化工具，结合skills实现浏览器操作。
...
OpenMontage。官方自称世界首个开源Agentic视频生产系统，目前冲到了GitHub Trending TOP1。
- 包含12条生产管线，动画解说、纪录片蒙太奇、播客切片、电影预告啥的。
- 里面包含 52个工具，500 多个Agent Skills，覆盖14家视频生成、10家图像、4家TTS、3家音乐。
- 开源：[https://github.com/calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)
...
- claude-tap。追踪本地agent执行，看出模型调用过程。通过代理的方式，把 Claude Code、Codex等模型的执行过程进行转发，实现模型请求过程的实时检查，可以查看模型调用过程使用的参数、返回值、调用顺序等。
    - 开源：[https://github.com/liaohch3/claude-tap](https://github.com/liaohch3/claude-tap)
- kooky。多个cli工具聚合平台。
    - 开源地址：[https://github.com/iAmCorey/kooky](https://github.com/iAmCorey/kooky)
