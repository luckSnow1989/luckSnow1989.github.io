...
[关闭这几个系统服务，让你的电脑不再卡！](https://zhuanlan.zhihu.com/p/82583125)
1. 禁用 "Connected User Experiences and Telemetry "服务
2. 禁用 四个"Diagnostic"服务
3. 高级优化工具。Dism++[https://github.com/Chuyu-Team/Dism-Multi-language/releases](https://github.com/Chuyu-Team/Dism-Multi-language/releases)



## 投屏

将电脑投票到其他电脑、笔记本、平板、手机。
1. 品牌生态。例如华为、苹果、小米、荣耀等
2. 使用spacedesk。电脑安装服务端、显式端安装客户端。可以使用USB和WiFi连接。有一定的延迟。
   [https://www.spacedesk.net/](https://www.spacedesk.net/)
...
- 网站分析
    ...
    - Proxy SwitchyOmega。是Chrome和Firefox浏览器上的代理扩展程序，可以轻松快捷的管理和切换多个代理设置，支持HTTP、HTTPS、SOCKS4、SOCKS5等多种代理协议。
    - FindSomething。该插件用于快速在网页的html源码或js代码中提取一些有趣的信息，包括可能请求的资源、接口的url，可能请求的ip和域名，泄漏的证件号、手机号、邮箱等信息。
    - Hack-Tools。是一个用于web应用程序渗透测试的web插件，它包括渗透测试期间使用的大部分工具，如XSSpayload、反弹shell payload等等
