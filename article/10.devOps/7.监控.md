...
### 3.1.【链路追踪】Spring Cloud Sleuth + Zipkin
...
现在很多Logstash 被 filebeat替换，ElasticSearch 被clickhouse提花

### 3.9.【链路追踪】Google-Dapper
...
### 3.10.【链路追踪】OpenTelemetry
- OpenTracing。早期被提出的链路追踪协议，目前发展非车成熟。
