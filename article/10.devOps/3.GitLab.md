...
- [美团代码托管平台的演进与实践](https://mp.weixin.qq.com/s/aY-QJN2Fkp86ATdvqVvpZQ)
...
[用户管理、项目管理、组管理、权限管理](https://blog.csdn.net/lijinzhou2017/article/details/88575700)
...
项目中添加必要的文件，起到辅助项目管理的作用。

- README.md。项目的说明文档，可以写项目的介绍、简述使用案例等，如果内容非常多的话，可以使用Gitlab的wiki功能
- .gitlab-ci.yml。pipeline配置文件。[说明文档](https://docs.gitlab.com/ee/ci/yaml/index.html#stages)
- LICENSE。开源协议文件。
- CHANGELOG。每次版本的修改内容

### 2.4.自动tag与发布release

[gitlab 创建release, 发布release](https://blog.51cto.com/u_16099320/10158024)
