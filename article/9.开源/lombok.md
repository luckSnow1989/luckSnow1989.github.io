...
作用于类上，生成日志变量。针对不同的日志实现产品，有不同的注解：@Log4j, @Log4j2, @Slf4j, @XSlf4j, @CommonsLog, @JBossLog, @Flogger
...
[https://blog.csdn.net/qq_42449963/article/details/118440341](https://blog.csdn.net/qq_42449963/article/details/118440341)
...
当它被 javac 加载创建后，会执行 init 方法，在这个方法中会启动一个特殊的类加载器 ShadowClassLoader ，
...
原理[/article/1.Java基础/3.JDK特性.html#3JSR](/article/1.Java基础/3.JDK特性.html#3JSR)

### 5.2.自定义Lombok注解

[自定义Lombok注解](https://blog.csdn.net/qq_42563471/article/details/127890125)