...
教程
- [一分钟安装使用](https://blog.51cto.com/u_14625168/2508627)
- [MinIO 纠删码(erasure code) 模式](https://blog.51cto.com/u_14625168/2509279)
- [MinIO 客户端使用](https://blog.51cto.com/u_14625168/2509439)
- [数据组织结构介绍](https://blog.51cto.com/u_14625168/2510695)
- [架构特性](https://blog.51cto.com/u_14625168/2510697)
- [元数据介绍](https://blog.51cto.com/u_14625168/2511642)
...
![](./img/文件存储/10305868062100.png)

页面的效果就如上图所示。

## fastDFS

<div name="wordShowDiv" word-url="./file/分布式存储/fastDFS.docx"></div>