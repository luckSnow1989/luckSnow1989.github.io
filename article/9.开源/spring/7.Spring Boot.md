...
springboot版本升级频率比较高，且不完全向下兼容，升级时需要谨慎。

1. [Spring Boot 3.3.x、3.4.x、3.5.x 深度对比与演进分析——从稳定性、架构能力到长期演进策略的系统性解读](https://mp.weixin.qq.com/s/pydByS1J6VjBXnzHCoifnw)
2. [告别手动升级！SpringBoot4 迁移工具节省95%时间](https://mp.weixin.qq.com/s/t-ExcL-Jo_Xhl5fyImwndA)
