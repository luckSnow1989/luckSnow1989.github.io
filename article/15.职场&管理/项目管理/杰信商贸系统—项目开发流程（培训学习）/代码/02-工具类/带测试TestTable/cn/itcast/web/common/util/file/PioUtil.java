...
public class PioUtil {
	...
	public void setPicture(HSSFWorkbook wb, HSSFPatriarch patriarch,
		...
		if (imgFile.exists()) {
			...
			HSSFClientAnchor anchor = new HSSFClientAnchor(20, 1, 1018, 0,
					(short) (iColStart), iRowStart, (short) (iColStop),
					iRowStop);
			patriarch.createPicture(anchor, wb.addPicture(byteArrayOut
					.toByteArray(), HSSFWorkbook.PICTURE_TYPE_JPEG));
		}
	...
	public HSSFCellStyle moneyrv10_BorderThin(HSSFWorkbook wb,
	...
	public HSSFCellStyle numberrv10_BorderThin(HSSFWorkbook wb,
	...
	public HSSFCellStyle moneyrv12_BorderThin(HSSFWorkbook wb,
			HSSFFont defaultFont12, short rmb2Format) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setFont(defaultFont12);
	...
	public HSSFCellStyle money1(HSSFWorkbook wb, HSSFFont defaultFont10,
			short money1Format) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setFont(defaultFont10);
	...
	public HSSFCellStyle money2(HSSFWorkbook wb, HSSFFont defaultFont10,
			short money2Format) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setFont(defaultFont10);
	...
	public HSSFCellStyle datevEN(HSSFWorkbook wb, HSSFFont defaultFont10,
			short datevENFormat) {
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setFont(defaultFont10);
