...
spring cloud中提到的负载均衡默认指定的是：Ribbon 和 LoadBalancer
...
- LVS
    - 优点：工作在4层，仅做分发作用，没有流量产生，因此性能极高，能处理海量连接，对内存和cpu消耗率更低；
